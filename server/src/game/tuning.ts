export const GAME_TUNING = {
  ...
  movement: {
    ...
    impulsePerTick: 0.14,
    maxHorizontalSpeed: 3.55,
    sprintImpulseMultiplier: 1.22,
    sprintMaxSpeedMultiplier: 1.2,
    carryMoveScale: 0.7,
  ...
  push: {
    ...
    verticalHitImpulse: 0.4,
    momentumMinMultiplier: 0.85,
    momentumMaxMultiplier: 1.12,
    momentumReferenceSpeed: 3.55,
  },
  ...
  ledge: {
    ...
    inwardInputDot: 0.3,
    climbDurationMs: 620,
    climbInwardDistance: 1.7,
    climbTargetY: 0.96,
    climbRecoveryMs: 360,
    successfulClimbBalance: 0.62,
